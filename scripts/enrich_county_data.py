...
BATCH_FILES: list[tuple[str, str]] = [
    # Inflow
    ("data/original/county_inflow/countyinflow9091.csv",    "data/enriched/county_inflow/countyinflow9091_enriched.csv"),
    ("data/original/county_inflow/countyinflow9192.csv",    "data/enriched/county_inflow/countyinflow9192_enriched.csv"),
    ("data/original/county_inflow/countyinflow9293.csv",    "data/enriched/county_inflow/countyinflow9293_enriched.csv"),
    ("data/original/county_inflow/countyinflow9394.csv",    "data/enriched/county_inflow/countyinflow9394_enriched.csv"),
    ("data/original/county_inflow/countyinflow9495.csv",    "data/enriched/county_inflow/countyinflow9495_enriched.csv"),
    ("data/original/county_inflow/countyinflow9596.csv",    "data/enriched/county_inflow/countyinflow9596_enriched.csv"),
    ("data/original/county_inflow/countyinflow9697.csv",    "data/enriched/county_inflow/countyinflow9697_enriched.csv"),
    ("data/original/county_inflow/countyinflow9798.csv",    "data/enriched/county_inflow/countyinflow9798_enriched.csv"),
    ("data/original/county_inflow/countyinflow9899.csv",    "data/enriched/county_inflow/countyinflow9899_enriched.csv"),
    ("data/original/county_inflow/countyinflow9900.csv",    "data/enriched/county_inflow/countyinflow9900_enriched.csv"),
    ("data/original/county_inflow/countyinflow0001.csv",    "data/enriched/county_inflow/countyinflow0001_enriched.csv"),
    ("data/original/county_inflow/countyinflow0102.csv",    "data/enriched/county_inflow/countyinflow0102_enriched.csv"),
    ("data/original/county_inflow/countyinflow0203.csv",    "data/enriched/county_inflow/countyinflow0203_enriched.csv"),
    ("data/original/county_inflow/countyinflow0304.csv",    "data/enriched/county_inflow/countyinflow0304_enriched.csv"),
    ...
    # Outflow
    ("data/original/county_outflow/countyoutflow9091.csv",  "data/enriched/county_outflow/countyoutflow9091_enriched.csv"),
    ("data/original/county_outflow/countyoutflow9192.csv",  "data/enriched/county_outflow/countyoutflow9192_enriched.csv"),
    ("data/original/county_outflow/countyoutflow9293.csv",  "data/enriched/county_outflow/countyoutflow9293_enriched.csv"),
    ("data/original/county_outflow/countyoutflow9394.csv",  "data/enriched/county_outflow/countyoutflow9394_enriched.csv"),
    ("data/original/county_outflow/countyoutflow9495.csv",  "data/enriched/county_outflow/countyoutflow9495_enriched.csv"),
    ("data/original/county_outflow/countyoutflow9596.csv",  "data/enriched/county_outflow/countyoutflow9596_enriched.csv"),
    ("data/original/county_outflow/countyoutflow9697.csv",  "data/enriched/county_outflow/countyoutflow9697_enriched.csv"),
    ("data/original/county_outflow/countyoutflow9798.csv",  "data/enriched/county_outflow/countyoutflow9798_enriched.csv"),
    ("data/original/county_outflow/countyoutflow9899.csv",  "data/enriched/county_outflow/countyoutflow9899_enriched.csv"),
    ("data/original/county_outflow/countyoutflow9900.csv",  "data/enriched/county_outflow/countyoutflow9900_enriched.csv"),
    ("data/original/county_outflow/countyoutflow0001.csv",  "data/enriched/county_outflow/countyoutflow0001_enriched.csv"),
    ("data/original/county_outflow/countyoutflow0102.csv",  "data/enriched/county_outflow/countyoutflow0102_enriched.csv"),
    ("data/original/county_outflow/countyoutflow0203.csv",  "data/enriched/county_outflow/countyoutflow0203_enriched.csv"),
    ("data/original/county_outflow/countyoutflow0304.csv",  "data/enriched/county_outflow/countyoutflow0304_enriched.csv"),
...
def normalize_legacy_county_row(row: dict, direction: str) -> dict:
    """Map pre-0809 column names to the standard y1/y2 naming convention."""
    if direction == "inflow":
        return {
            "y2_statefips":  row["State_Code_Dest"],
            "y2_countyfips": row["County_Code_Dest"],
            "y1_statefips":  row["State_Code_Origin"],
            "y1_countyfips": row["County_Code_Origin"],
            "y1_state":      row.get("State_Abbrv", ""),
            "y1_countyname": row.get("County_Name", ""),
            "n1":            row["Return_Num"],
            "n2":            row["Exmpt_Num"],
            "AGI":           row["Aggr_AGI"],
        }
        ...
        return {
            ...
            "y2_countyname": row.get("County_Name", ""),
            "n1":            row["Return_Num"],
            "n2":            row["Exmpt_Num"],
            "AGI":           row["Aggr_AGI"],
        }
...
def enrich(
    ...
    with (
        ...
        for raw_row in reader:
            ...
            row = normalize_legacy_county_row(raw_row, direction) if legacy else raw_row
