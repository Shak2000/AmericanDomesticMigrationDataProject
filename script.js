 ...
 * remote database.
 */
const DB_LENGTH_BYTES = 974958592;
 ...
 */
const YEARS = [
    '9394', '9495', '9596', '9697', '9798', '9899', '9900', '0001', '0102', '0203', '0304', '0405', '0506', '0607', '0708', '0809', '0910', '1011', '1112', '1213', '1314', '1415',
    '1516', '1617', '1718', '1819', '1920', '2021', '2122', '2223'
];

/** Human-readable labels for each year tag. */
const YEAR_LABELS = {
    '9394': '1993–1994', '9495': '1994–1995', '9596': '1995–1996', '9697': '1996–1997', '9798': '1997–1998', '9899': '1998–1999', '9900': '1999–2000', '0001': '2000–2001', '0102': '2001–2002', '0203': '2002–2003', '0304': '2003–2004', '0405': '2004–2005', '0506': '2005–2006', '0607': '2006–2007', '0708': '2007–2008', '0809': '2008–2009', '0910': '2009–2010', '1011': '2010–2011', '1112': '2011–2012', '1213': '2012–2013',
...
function initUI() {
    ...
    const yearLabel = document.getElementById('year-display');
    if (slider && yearLabel) {
        // Dynamically sync the slider range to the YEARS array length
