...
- [x] Download and enrich state and county inflow/outflow data for 2007-08
- [x] Rebuild SQLite DB and verify the year appears in the app

### Milestone 11.2 – 2006-07
- [x] Download and enrich state and county inflow/outflow data for 2006-07
- [x] Rebuild SQLite DB and verify the year appears in the app

### Milestone 11.3 – 2005-06
- [x] Download and enrich state and county inflow/outflow data for 2005-06
- [x] Rebuild SQLite DB and verify the year appears in the app

### Milestone 11.4 – 2004-05
- [x] Download and enrich state and county inflow/outflow data for 2004-05
- [x] Rebuild SQLite DB and verify the year appears in the app

### Milestone 11.5 – 2003-04
- [x] Download and enrich state and county inflow/outflow data for 2003-04
- [x] Rebuild SQLite DB and verify the year appears in the app

### Milestone 11.6 – 2002-03
- [x] Download and enrich state and county inflow/outflow data for 2002-03
- [x] Rebuild SQLite DB and verify the year appears in the app

### Milestone 11.7 – 2001-02
- [x] Download and enrich state and county inflow/outflow data for 2001-02
- [x] Rebuild SQLite DB and verify the year appears in the app

### Milestone 11.8 – 2000-01
- [x] Download and enrich state and county inflow/outflow data for 2000-01
- [x] Rebuild SQLite DB and verify the year appears in the app

### Milestone 11.9 – 1999-00
- [x] Download and enrich state and county inflow/outflow data for 1999-00
- [x] Rebuild SQLite DB and verify the year appears in the app

### Milestone 11.10 – 1998-99
- [x] Download and enrich state and county inflow/outflow data for 1998-99
- [x] Rebuild SQLite DB and verify the year appears in the app

### Milestone 11.11 – 1997-98
- [x] Download and enrich state and county inflow/outflow data for 1997-98
- [x] Rebuild SQLite DB and verify the year appears in the app

### Milestone 11.12 – 1996-97
- [x] Download and enrich state and county inflow/outflow data for 1996-97
- [x] Rebuild SQLite DB and verify the year appears in the app

### Milestone 11.13 – 1995-96
- [x] Download and enrich state and county inflow/outflow data for 1995-96
- [x] Rebuild SQLite DB and verify the year appears in the app

### Milestone 11.14 – 1994-95
- [x] Download and enrich state and county inflow/outflow data for 1994-95
- [x] Rebuild SQLite DB and verify the year appears in the app

### Milestone 11.15 – 1993-94
- [x] Download and enrich state and county inflow/outflow data for 1993-94
- [x] Rebuild SQLite DB and verify the year appears in the app
